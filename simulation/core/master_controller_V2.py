import pandas as pd
import numpy as np
from simulation.core.hourly_sanity_check import get_tilt
...
class LiveGatedForge:
    def __init__(self, ticker):
        ...
        is_24h = any(x in ticker for x in ['USD', 'EUR', 'GBP', 'JPY', 'CHF', 'CAD', 'AUD', 'BTC', 'ETH', 'SOL', 'XRP', 'ADA', 'DOGE', 'BNB', 'LINK', 'MATIC', 'AVAX'])
    ...
    def get_signal(self):
        ...
        # FIX: Restored dynamic micro-to-macro coupling
        t_h = get_tilt(f_h, rds)
